...
reqst_channel = environ.get('REQST_CHANNEL','KNMoviesHub17')
...
OWNER_LNK = environ.get('OWNER_LNK', 'Nandi177')
...
CUSTOM_FILE_CAPTION =environ.get("CUSTOM_FILE_CAPTION","📂ғɪʟᴇ_ɴᴀᴍᴇ :@KNMoviesHub17 - -{file_name}\n⚙ SIZE : {file_size}")
