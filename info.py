...
API_ID = int(environ.get('API_ID', '36373667'))
API_HASH = environ.get('API_HASH', 'c98cb32ad8876a3d00acc646f2eb6e1f')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5555452683').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003642261658'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003710820618').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://usa253714_db_user: pdOeWONIUbohZyLu@cluster0.ondh4li.mongodb.net/?
appName=Clustero")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', derxfdd'') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.


# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+hd2ZxGwLpzUwMjk1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+GILQKBpudfgyZjQ1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'movie_my_bot') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/ZEINTGL')
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'f9eed85e15870baeac774ac2576853c8ace8768c')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/+GILQKBpudfgyZjQ1') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
